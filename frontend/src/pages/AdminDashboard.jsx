...
const AdminDashboard = () => {
  ...
  const [musicForm, setMusicForm] = useState({ title: '', artist: '', url: '', description: '' });
  ...
  const handleMusicUpload = async (e) => {
    ...
    try {
      ...
      setMusicForm({ title: '', artist: '', url: '', description: '' });
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl border border-gray-200/50 p-8">
              ...
              <form onSubmit={handleMusicUpload} className="grid gap-8 md:grid-cols-2">
                <div>
                  <label className="block text-sm font-bold text-gray-800 mb-3">Track Title</label>
                  <input
                    name="title"
                ...
                <div>
                  <label className="block text-sm font-bold text-gray-800 mb-3">Artist Name</label>
                  <input
                    name="artist"
                ...
                <div className="md:col-span-2">
                  <label className="block text-sm font-bold text-gray-800 mb-3">Audio URL</label>
                  <input
                    name="url"
                    value={musicForm.url}
                    onChange={handleMusicChange}
                ...
                <div className="md:col-span-2">
                  ...
                  <textarea
                    ...
                    onChange={handleMusicChange}
                    placeholder="Brief description of the track and its mood"
                    rows="3"
                    className="w-full p-4 border-2 border-gray-200 rounded-2xl focus:ring-4 focus:ring-purple-100 focus:border-purple-500 transition-all duration-300 bg-white/50 backdrop-blur-sm resize-none"
                  />
                </div>
            ...
            <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl border border-gray-200/50 p-8">
              <div className="mb-8">
                <h2 className="text-3xl font-bold text-gray-900 mb-2">Current Music Library</h2>
                <p className="text-gray-600">Manage your uploaded background tracks</p>
              </div>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-4">
                          ...
                          <div>
                            ...
                            {track.artist && <p className="text-gray-600">{track.artist}</p>}
